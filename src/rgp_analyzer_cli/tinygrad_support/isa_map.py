...
from ..vendor.tinygrad_sqtt import decode
...
def render_tinygrad_isa_map(result: dict[str, Any], limit: int = 32) -> str:
    lines = [
        f"tinygrad_isa_map: vendor={result.get('tinygrad_vendor', 'vendored')} stream={result['stream_index']} "
...
def render_dispatch_isa_map(result: dict[str, Any], limit: int = 16) -> str:
    lines = [
        f"dispatch_isa_map: vendor={result.get('tinygrad_vendor', 'vendored')} stream={result['stream_index']} dispatches={result['dispatch_count']} "
