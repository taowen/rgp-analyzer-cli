...
def _load_v1_modules():
    ...
    from rgp_analyzer_cli_v1.shader_triage import shader_triage as v1_shader_triage
    ...
    return {
        ...
        "shader_triage": v1_shader_triage,
...
def _v1_payloads(path: Path) -> dict[str, Any]:
    ...
    helper = v1["resolve_helper_path"](v1["repo_root"](), None, True)
